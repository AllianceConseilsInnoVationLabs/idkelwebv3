...
import promoCardBg from "@public/promo-card-bg.jpg";
    ...
    >
      ...
      <div className="flex flex-col justify-between p-5 pb-6 sm:p-6">
        <h5 className="mb-2 text-lg font-semibold tracking-tight text-gray-900">
          {t("text-released-new-update")}
        </h5>
        <p className="mb-5 text-sm font-normal text-gray-500">
          {t("text-released-new-update-details")}
        </p>
  ...
  return (
    <div className={cn("pb-3 pt-9 @2xl:grid @2xl:grid-cols-6 @2xl:pt-11", className)}>
      <div className="col-span-2 mb-6 @5xl:mb-0">
        <Title
          as="h6"
          className={cn("text-xl font-semibold", titleClassName)}
        >
          {title}
        </Title>
