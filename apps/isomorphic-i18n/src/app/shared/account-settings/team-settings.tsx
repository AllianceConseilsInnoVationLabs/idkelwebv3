  ...
  return (
    <div className="@container">
      <HorizontalFormBlockWrapper
        ...
        title={t("text-teams")}
        description={t("text-teams-description")}
      ...
      <HorizontalFormBlockWrapper
        ...
        childrenWrapperClassName="gap-0 @lg:gap-0"
        title={t("text-on-teams")}
        description={t("text-on-teams-description")}
      >
      ...
      <HorizontalFormBlockWrapper
        childrenWrapperClassName="gap-0 @lg:gap-0"
        title={t("text-where-you-logged-in")}
        description={t("text-where-you-logged-in-description")}
