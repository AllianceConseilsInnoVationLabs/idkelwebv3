...
export default function Decaissements({ className, datas, setNewOpen, refreshData, setOpenHistory, isHistoryLoading, setIsHistoryLoading, setHistoryData}: DecaissementsProps) {
  ...
  const onDeleteItem = useCallback(async (id: string) => {
    ...
    if (deletion.success) {
      ...
      toast({
        ...
        description: "Décaissement supprimé avec succès",
